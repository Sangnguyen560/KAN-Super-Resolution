...
def test_metrics_kan_sr(model, test_loader, output_metrics_path="./Output_FashionMNIST/output_kan_sr/test_metrics.txt"):
    model.eval()
    total_psnr, total_ssim = 0, 0
    with torch.no_grad():
...
def train_kan_sr(model, train_loader, val_loader, epochs=25, lr=0.005, patience=5):
    ...
    plt.legend()
    plt.grid()
    plt.savefig("./Output_FashionMNIST/output_kan_sr/psnr_plot.pdf")
    plt.close()

    return model, total_train_time

def test_kan_sr(model, test_loader, output_path="./Output_FashionMNIST/output_kan_sr/results_kan_sr.pdf"):
...
def main():
    train_dataset_file = "./train_data_set/KAN_SR/FashionMNIST/train_dataset.pt"
    val_dataset_file = "./val_data_set/Kan_SR/FashionMNIST/val_dataset.pt"
    test_dataset_file = "./test_data_set/KAN_SR/FashionMNIST/test_dataset.pt"
    output_metrics_path = "./Output_FashionMNIST/output_kan_sr/test_metrics.txt"
