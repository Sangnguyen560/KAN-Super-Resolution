...
def test_metrics_cnn_sr(model, test_loader, output_metrics_path="./Output_MNIST/output_cnn/test_metrics.txt"):
    model.eval()
    total_psnr, total_ssim = 0, 0
    with torch.no_grad():
...
def train_cnn_sr(model, train_loader, val_loader, epochs=25, lr=0.005, patience=5):
    ...
    plt.legend()
    plt.grid()
    plt.savefig("./Output_MNIST/output_cnn/psnr_cnn_plot.pdf")
    plt.close()

    return model, total_train_time

def test_cnn_sr(model, test_loader, output_path="./Output_MNIST/output_cnn/results_cnn.pdf"):
...
def main():
    train_dataset_file = "./train_data_set/CNN/MNIST/train_dataset.pt"
    val_dataset_file = "./val_data_set/CNN/MNIST/val_dataset.pt"
    test_dataset_file = "./test_data_set/CNN/MNIST/test_dataset.pt"
    output_metrics_path = "./Output_MNIST/output_cnn/test_metrics.txt"
